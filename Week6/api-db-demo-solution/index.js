...
ACCESS_TOKEN_SECRET = "abc123"; // typically in .env
const SALT = "eorihr230herogiwhfoidfughewofhe";
...
const hashPassword = (password) => {
    const key = pbkdf2.pbkdf2Sync(password, SALT, 1000, 64, `sha512`).toString(`hex`);
    return key;
}
